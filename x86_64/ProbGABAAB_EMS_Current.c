...
#define nrn_init _nrn_init__ProbGABAAB_EMS_Current
#define _nrn_initial _nrn_initial__ProbGABAAB_EMS_Current
#define nrn_cur _nrn_cur__ProbGABAAB_EMS_Current
#define _nrn_current _nrn_current__ProbGABAAB_EMS_Current
#define nrn_jacob _nrn_jacob__ProbGABAAB_EMS_Current
#define nrn_state _nrn_state__ProbGABAAB_EMS_Current
#define _net_receive _net_receive__ProbGABAAB_EMS_Current 
#define setRNG setRNG__ProbGABAAB_EMS_Current 
#define state state__ProbGABAAB_EMS_Current 
...
#define toggleVerbose toggleVerbose_ProbGABAAB_EMS_Current
#define urand urand_ProbGABAAB_EMS_Current
 extern double toggleVerbose( _threadargsproto_ );
 extern double urand( _threadargsproto_ );
 /* declare global and static user variables */
#define gmax gmax_ProbGABAAB_EMS_Current
 double gmax = 0.001;
 ...
 "gmax_ProbGABAAB_EMS_Current", "uS",
 "tau_r_GABAA", "ms",
 "tau_d_GABAA", "ms",
 "tau_r_GABAB", "ms",
 "tau_d_GABAB", "ms",
 ...
 "gmax_ProbGABAAB_EMS_Current", &gmax_ProbGABAAB_EMS_Current,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _ProbGABAAB_EMS_Current_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 ProbGABAAB_EMS_Current /ems/elsc-labs/segev-i/toviah.moldwin/Documents/Liclipse Workspace New/MinimalBP/x86_64/ProbGABAAB_EMS_Current.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("ProbGABAAB_EMS_Current", "cannot be used with CVODE"); return 0;}
