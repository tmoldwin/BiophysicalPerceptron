...
#define nrn_init _nrn_init__ProbAMPANMDA_EMS_Current
#define _nrn_initial _nrn_initial__ProbAMPANMDA_EMS_Current
#define nrn_cur _nrn_cur__ProbAMPANMDA_EMS_Current
#define _nrn_current _nrn_current__ProbAMPANMDA_EMS_Current
#define nrn_jacob _nrn_jacob__ProbAMPANMDA_EMS_Current
#define nrn_state _nrn_state__ProbAMPANMDA_EMS_Current
#define _net_receive _net_receive__ProbAMPANMDA_EMS_Current 
#define setRNG setRNG__ProbAMPANMDA_EMS_Current 
#define state state__ProbAMPANMDA_EMS_Current 
...
#define g_NMDA _p[18]
#define g _p[19]
#define A_AMPA_step _p[20]
#define B_AMPA_step _p[21]
#define A_NMDA_step _p[22]
#define B_NMDA_step _p[23]
#define Rstate _p[24]
#define tsyn_fac _p[25]
#define u _p[26]
#define A_AMPA _p[27]
#define B_AMPA _p[28]
#define A_NMDA _p[29]
...
#define toggleVerbose toggleVerbose_ProbAMPANMDA_EMS_Current
#define urand urand_ProbAMPANMDA_EMS_Current
...
#define _gth 0
#define gmax gmax_ProbAMPANMDA_EMS_Current
 double gmax = 0.001;
#define mggate_ProbAMPANMDA_EMS_Current _thread1data[0]
#define mggate _thread[_gth]._pval[0]
 ...
 "gmax_ProbAMPANMDA_EMS_Current", "uS",
 "tau_r_AMPA", "ms",
 "tau_d_AMPA", "ms",
 "tau_r_NMDA", "ms",
 "tau_d_NMDA", "ms",
 ...
 "mggate_ProbAMPANMDA_EMS_Current", &mggate_ProbAMPANMDA_EMS_Current,
 "gmax_ProbAMPANMDA_EMS_Current", &gmax_ProbAMPANMDA_EMS_Current,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _ProbAMPANMDA_EMS_Current_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA_EMS_Current /ems/elsc-labs/segev-i/toviah.moldwin/Documents/Liclipse Workspace New/MinimalBP/x86_64/ProbAMPANMDA_EMS_Current.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("ProbAMPANMDA_EMS_Current", "cannot be used with CVODE"); return 0;}
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   mggate = 1.0 / ( 1.0 + exp ( ( gateConstant * 1.0 ) * - ( v ) ) * ( mg / 3.57 ) ) ;
